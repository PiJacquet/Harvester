...
public class VisitMembersLinkedin extends Scenario {
	...
	public VisitMembersLinkedin(WebDriver driver) {
		super(driver);
	...
	public void mining() {
		...
		driver.get("https://www.linkedin.com/search/results/people/?facetGeoRegion=%5B%22fr%3A0%22%5D&facetIndustry=%5B%2296%22%2C%224%22%2C%226%22%2C%22118%22%5D&keywords=alternant&origin=FACETED_SEARCH&page=53");
